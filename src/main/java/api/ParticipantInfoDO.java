...
public class ParticipantInfoDO {
	...
	private String paticipantsPUUID;
	...
	public String getPaticipantsPUUID() {
		return paticipantsPUUID;
	}

	public void setPaticipantsPUUID(String paticipantsPUUID) {
		this.paticipantsPUUID = paticipantsPUUID;
	}
